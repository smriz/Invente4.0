          ...
          <div className="hosp">
            ...
            <div className="content">
              ...
              <div align="center">
                ...
                <br />
                <p className="note">
                  Note: From Kelambakkam to SSN board any share auto or bus
                  going to Thiruporur
                </p>
                ...
                <br />
                <ul style={{ margin: '0px 15%', lineHeight: '25px' }}>
                  <li>
                    Participants must bring their ID card or a copy of the
                    college ID Card while availing accomodation. Without the
                    copy, accomodation cannot be provided
                  </li>
                  <li>Accomodation Fees of Rs.150/- per day per person</li>
                  <li>Caution Deposit of Rs.100/-</li>
                  <li>
                    Rooms will be allocated on shared basis only, with 2 people
                    in a room
                  </li>
