        ...
        <div id="hod">        
            ...
            <div className="card-set">
              {this.hod.map((x, index) => (
                <div className="card-set-child " align="center" key={"hod-" + index}>
                  <img className="img" src={require("../images/organisers/hod-"+x.img+".jpg")} alt={"hod-image-"+index }/>
          ...
          <div
            ...
            data-aos-duration="1000"
          >
          <div id="staff-coordinator" style={{marginTop:"5%"}}>
            <div>
            ...
            <div className="card-set">
              {this.staff.map((x, index) => (
                <div className="card-set-child" align="center" key={"fac-" + index}>
                  <img
                    src={require("../images/organisers/fac-" + x.img + ".jpg")}
          ...
          <div
            ...
            data-aos-duration="1000"
          >
          <div id="student-coordinator" style={{marginTop:"5%"}}>
            <div>
            ...
            <div className="card-set" >
              {this.student.map((x, index) => (
                <div className="card-set-child" align="center" key={"stu-" + index}>
                  <img
